...
async function getdata(){
  ...
  const docRef = doc(db, `/Admin/${zz}/${grp}/`, (getperiod));
    ...
    // document.getElementById("de").innerHTML='Group Name:'+name;
    // document.getElementById("d").innerHTML='Period:   '+ddid;
    // document.getElementById("dee").innerHTML='Start Date:'+sd;
    // document.getElementById("deee").innerHTML='End Date:'+ed;
    // document.getElementById("deeee").innerHTML='Pin:'+pin;
        ...
        <div className='left'>
          ...
          <div class="container bg-primary gradient-custom-2 ">  
            ...
            <form id="theForm" class="row g-2 mt-5 ">
                ...
                <div class="col-sm-6">
                    <label for="memberloan" class="form-label"><h4>{t('total_loan_amount')} :{loanr} </h4></label>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    <label for="bankbalance" class="form-label"><h4>{t('amount_per_member')} : {vatani}</h4></label>
                </div>
                <div class="col-sm-6">
