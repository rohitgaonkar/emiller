...
function ViewFinishedLoans(props) {
         ...
         for(var i=0;i<myElements.length;i++){
              if(myElements[i].checked==true){
                console.log(table.rows[i+1].cells[2].innerHTML);
                    ViewFinishedLoans(table.rows[i+1].cells[2].innerHTML,table.rows[i+1].cells[3].innerHTML,table.rows[i+1].cells[7].innerHTML);
              }
          }
      }
...
///////////////////////////////////////////////////
  function ViewFinishedLoans(ooo,id,amount){
...
export default memo (ViewFinishedLoans);
